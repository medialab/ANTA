 ...
 * 
 * examples of usage :
 * $myPacker = new Ui_JavaScriptPacker($script, 62, true, false);
 * $packed = $myPacker->pack();
 * 
 * or
 * 
 * $myPacker = new Ui_JavaScriptPacker($script, 'Normal', true, false);
 * $packed = $myPacker->pack();
 * 
 * or (default values)
 * 
 * $myPacker = new Ui_JavaScriptPacker($script);
 * $packed = $myPacker->pack();
 * 
 * 
...
class Ui_JavaScriptPacker {
	...
	private function _bootStrap($packed, $keywords) {
		...
		$unpackPacker = new Ui_JavaScriptPacker($unpack, 0, false, true);
